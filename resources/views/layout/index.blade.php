	...
	<header id="topnav" class="navbar navbar-default navbar-fixed-top clearfix" role="banner">
		<span id="trigger-sidebar" class="toolbar-trigger toolbar-icon-bg">
			<a data-toggle="tooltips" data-placement="right" title="Toggle Sidebar"><span class="icon-bg"><i
						class="fas fa-fw fa-bars"></i></span></a>
		</span>
		...
		<ul class="nav navbar-nav toolbar pull-right">
			<li class="dropdown toolbar-icon-bg" style="padding-right: 8px;">
				<a href="{{ route('profile') }}" class="dropdown-toggle" data-toggle="dropdown"><span class="icon-bg"><i
						...
						<div class="widget stay-on-collapse" id="widget-sidebar">
							<nav role="navigation" class="widget-body">
								<ul class="acc-menu">
									...
									<li>
										<a href="{{route('showFormInstalasi')}}"><i
												class="fa fa-file-signature"></i><span>Buat Laporan Baru</span></a>
									</li>
									<li>
