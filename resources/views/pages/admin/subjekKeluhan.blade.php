...
<div class="static-content">
    <div class="page-content">
        <ol class="breadcrumb">
            ...
            <li>Manajemen</li>
            <li class="active"><a href="">Subject-Keluhan</a></li>
        </ol>
        <div class="page-heading">
            <h1>Subject Keluhan</h1>
        </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2>Daftar Subject Keluhan</h2>
                            <div class="options">
                                <ul class="nav nav-tabs">
                                    <li ><a class="active show" data-toggle="tab" href="#edit-subject" >Edit Subject</a></li>
                                    <li><a data-toggle="tab" href="#tambah-subject">Tambah Subject</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <div class="panel-body">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="edit-subject">
                                    ...
                                    <div class="tab-pane" id="tambah-subject">
                                            <form action="{{route('add-subjek')}}" method="POST" class="form-horizontal row-border"
                                            data-parsley-validate data-parsley-errors-messages-disabled id="validate-form"> {{ csrf_field() }}
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label" style="padding-top: 11px !important;">Ketikkan Subject Keluhan Baru</label>
                                                <div class="col-sm-7">
                                                    <div class="wrap-input100" data-validate="Kolom tidak boleh kosong">
                                                        <input required class="input100" type="text" name="nama_subjek"
                                                        autocomplete="off" placeholder="ketik disini kaka...">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <p class="modal-title" id="exampleModalLabel">Form Edit Subjek</p>
            </div>
            <div class="modal-body" style="margin-top: 10px !important">
                <form action="{{route('update-subjek')}}" method="POST" class="form-horizontal row-border"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="wrap-input100" data-validate="Kolom tidak boleh kosong">
                            <input placeholder="Masukkan Nama Subjek" required class="input100" name="nama_subjek"
                                type="text" autofocus="autofocus" >
                                <span class="focus-input100" data-placeholder="Masukkan Nama Subjek"></span>    
                            <input name="id_subjek" required type="hidden">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="delete" class="btn btn-primary">Ya</button>
            </div>
        </div>
    </div>
</div> --}}
...
<script type="text/javascript" src="{{asset('demo/demo-subjek-keluhan.js')}}"></script>
@stop