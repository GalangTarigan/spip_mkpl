$(function () {
    ...
    var Date_start, Date_finished, status, uuid
    ...
    if (status == "Selesai") {
        ...
        $('.inbox-menu .panel .panel-heading .panel-ctrls').append('<a onClick="event.preventDefault(); print(\'' + uuid + '\')" class="button-icon has-bg"><i class="zmdi zmdi-print zmdi-hc-lg"></i></a>')
...
function print(data) {
    window.open('/admin/print/laporan-instalasi/?laporan=' + data, 'print', 'scrollbars=yes,status=no,menubar=no,width=800,height=400')
}
