        ...
        $.each(content, function(index, value){
            if(value.type == notifications_type.newReport){
                if(value.read_at == null){
                    ...
                    html+= '<li class="li-notif"><a class="notif-info" href="/daftar-proyek-instalasi/detail-proyek?laporan='+id_laporan+'"><div class="notif-icon"><i class="fas fa-file-signature"></i></div><div class="notif-content">Laporan instalasi '+'<strong>'+value.data['nama_instansi']+'</strong>'+' berhasil dibuat</div><div class="notif-time">'+diffDates(value.created_at)+'</div></a></li>'
                }else{
                    var id = value.data['id_laporan']
                    html+= '<li class="li-notif"><a class="notif-info" href="/daftar-proyek-instalasi/detail-proyek?laporan='+id+'"><div class="notif-icon"><i class="fas fa-file-signature"></i></div><div class="notif-content">Laporan instalasi '+'<strong>'+value.data['nama_instansi']+'</strong>'+' berhasil dibuat</div><div class="notif-time">'+diffDates(value.created_at)+'</div></a></li>'
                }
                ...
                if(value.read_at == null){
                    var to = '&read=' + value.id
                    var id_laporan = value.data['id_laporan'] + to
                    html+= '<li class="li-notif"><a class="notif-success" href="/daftar-proyek-instalasi/detail-proyek?laporan='+id_laporan+'"><div class="notif-icon"><i class="fa fa-chalkboard-teacher"></i></div><div class="notif-content">Laporan training '+'<strong>'+value.data['nama_instansi']+'</strong>'+' berhasil dibuat</div><div class="notif-time">'+diffDates(value.created_at)+'</div></a></li>'
                }else{
                    var id = value.data['id_laporan']
                    html+= '<li class="li-notif"><a class="notif-success" href="/daftar-proyek-instalasi/detail-proyek?laporan='+id+'"><div class="notif-icon"><i class="fa fa-chalkboard-teacher"></i></div><div class="notif-content">Laporan training '+'<strong>'+value.data['nama_instansi']+'</strong>'+' berhasil dibuat</div><div class="notif-time">'+diffDates(value.created_at)+'</div></a></li>'
                }
            }else if(value.type == notifications_type.newCReport){
                if(value.read_at == null){
                    var to = '&read=' + value.id
                    var id_laporan = value.data['id_laporan'] + to
                    html+= '<li class="li-notif"><a class="notif-primary" href="/keluhan/detail-keluhan?keluhan='+id_laporan+'"><div class="notif-icon"><i class="fab fa-teamspeak"></i></div><div class="notif-content">Laporan keluhan '+'<strong>'+value.data['nama_instansi']+'</strong>'+' berhasil dibuat</div><div class="notif-time">'+diffDates(value.created_at)+'</div></a></li>'
                }else{
                    var id = value.data['id_laporan']
                    html+= '<li class="li-notif"><a class="notif-primary" href="/keluhan/detail-keluhan?keluhan='+id+'"><div class="notif-icon"><i class="fab fa-teamspeak"></i></div><div class="notif-content">Laporan keluhan '+'<strong>'+value.data['nama_instansi']+'</strong>'+' berhasil dibuat</div><div class="notif-time">'+diffDates(value.created_at)+'</div></a></li>'
                }
            }
        })
        return html
